...
<td width=28%>
<a href="/EmployeeFormMVC/survey"> <button type="button">Enter Survey</button></a></td>
<td><p class="error"style="text-align:left">${surveyFailure}</p></td>
</tr>
</table>
<br><br><br>
<a href="/EmployeeFormMVC/Logout"> <button style="width:25%" type="button">Logout</button></a>
</div>
