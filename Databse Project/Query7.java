...
public class Query7 {
   ...
   public static void main (String args []) {
    try
    {
        ...
        CallableStatement cs = conn.prepareCall("begin StudentRegistration.student_enroll(?,?); end;");
        //register the out parameter (the first parameter)
        cs.setString(1, "B032");
        cs.setString(2,"c0001");
      ...
      catch (SQLException ge) 
{
        ...
        else if(ge.getErrorCode() == -20003) 
        {
           System.out.println("Error found");
        }
        else if(ge.getErrorCode() == -20004) 
        {
           System.out.println("Error found");
        }
        else if(ge.getErrorCode() == -20005) 
        {
           System.out.println("Error found");
        }
        else if(ge.getErrorCode() == -20006) 
        {
           System.out.println("Error found");
        }
        else if(ge.getErrorCode() == -20007) 
        {
           System.out.println("Error found");
        }
        else
