...
2. postings.​csv 
3. docsTable.​csv 
4. total.​txt (COntains the total number of words in the collection)

Then the Query Likelihood Model is used along with the information generated above to retrive the top five documents based on the input query.